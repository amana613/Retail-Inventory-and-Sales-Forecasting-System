...
const SuperAdminAdminsPage = () => {
  ...
  const handleCreateUser = async (e) => {
    ...
    try {
      ...
      await axios.post(
        "/api/admins",
        isAdmin ? { ...formData, role: "rider" } : formData,
        config,
      );
  ...
  return (
    <div className="admin-page">
      <div className="admin-page-header">
        <h2>
          {isAdmin ? "Manage Riders" : "Manage Personnel (Admins & Riders)"}
        </h2>
        <button
      ...
      {showAddForm && (
        ...
        >
          <h3>
            {isAdmin ? "Create New Rider" : "Create New Administrator or Rider"}
          </h3>
          <form
          ...
          >
            ...
            <button
              type="submit"
              className="btn-primary"
              style={{ justifySelf: "start", backgroundColor: "#e53935" }}
            >
              Create Account
            </button>
          </form>
              ...
              {users.length === 0 && (
                <tr>
                  <td colSpan="5" style={{ textAlign: "center" }}>
                    No administrators or riders found.
                  </td>
                </tr>
              )}
            </tbody>
