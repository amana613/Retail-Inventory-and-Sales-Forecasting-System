            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. 10"
                  title="The system will alert you when stock falls below this number"
                />
              </div>
              <div>
                <label
              ...
              <tr key={product._id}>
                <td>
                  <span style={{ fontFamily: "monospace", color: "#64748b" }}>
                    #
                    {product._id
                      .substring(product._id.length - 6)
                      .toUpperCase()}
                  </span>
                </td>
                <td>
                ...
                <td>
                  <span
                    className={`status-badge ${product.stock_qty > 10 ? "success" : product.stock_qty > 0 ? "warning" : "danger"}`}
                  >
                    {product.stock_qty || 0}
                  </span>
                </td>
