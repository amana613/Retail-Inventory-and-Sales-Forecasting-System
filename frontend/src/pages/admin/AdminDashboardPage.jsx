    ...
    <div className="admin-dashboard">
      ...
      <div className="dashboard-grid">
        ...
        <div className="stat-card">
          <div
            className="stat-icon pulse-soft"
      ...
      <div className="dashboard-tables-container">
        ...
        <div className="card recent-orders-card">
          <div className="card-header">
            <h3>
              <Clock size={18} style={{ marginRight: "8px" }} /> Recent
              Transactions
            </h3>
              ...
              <tbody>
                {dashboardData?.recentOrders?.map((order) => (
                  <tr key={order._id}>
                    ...
                    <td>
                      <span
                        className={`status-badge ${order.isDelivered ? "success" : order.isPaid ? "info" : "warning"}`}
                      >
                        {order.isDelivered
                          ? "Delivered"
                          : order.isPaid
              ...
              <tbody>
                {dashboardData?.lowStockProducts?.map((product) => (
                  <tr key={product._id}>
                    ...
                    <td>
                      <span
                        className={`status-badge ${product.stock_qty === 0 ? "bg-red-100 text-red-800" : "bg-yellow-100 text-yellow-800"}`}
                        style={{
                          backgroundColor:
                            product.stock_qty === 0 ? "#fee2e2" : "#fef3c7",
                          color:
                            product.stock_qty === 0 ? "#991b1b" : "#92400e",
                          padding: "4px 8px",
                          borderRadius: "4px",
                          fontSize: "0.75rem",
                          fontWeight: "600",
