  ...
  const renderStatusTracker = (status) => {
    ...
    if (s === "processing") {
      ...
      config = {
        ...
        bg: "#fef08a",
        text: "Dispatched",
        desc: "Your order is on the way! Handed over to our rider.",
      };
    } else if (s === "delivered") {
      config = {
        ...
        bg: "#dcfce3",
        text: "Delivered",
        desc: "Order was successfully completed.",
      };
    } else if (s === "cancelled") {
      config = {
                ...
                {order.orderItems.map((item, index) => (
                  <li key={index} className="order-list-item">
                    ...
                    <div className="item-calc">
                      ...
                      <strong>Rs. {(item.qty * item.price).toFixed(2)}</strong>
                    </div>
                  </li>
                ))}
              </ul>
          ...
          <div className="summary-card" style={{ marginTop: "20px" }}>
            ...
            {order.receiptImage ? (
              ...
              <div style={{ marginTop: "10px" }}>
                ...
                >
                  Please upload your transaction receipt to verify payment.
                </p>
                <input
                  type="file"
                  id="receipt-upload"
