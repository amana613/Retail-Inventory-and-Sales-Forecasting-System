...
const AdminSidebar = () => {
  ...
  return (
    <aside className="admin-sidebar" style={{ width: '250px', padding: '24px 0', borderRight: '1px solid #1E293B' }}>
      <div className="sidebar-brand" style={{ padding: '0 24px', marginBottom: '40px' }}>
        <h1 style={{ margin: 0, fontSize: '1.25rem', color: 'white', letterSpacing: '1px' }}>
